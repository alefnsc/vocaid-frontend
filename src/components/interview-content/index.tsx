    ...
    return (
        <Card className="xl:w-[80%] lg:w-[90%] w-[95%] flex flex-col p-4 sm:p-6 md:p-8 relative items-center justify-center mb-12 max-w-7xl shadow-xl bg-white/95 backdrop-blur-sm border-2 border-gray-200">
            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-10">
                <button 
                    onClick={onQuitClick}
                    aria-label={t('interview.buttons.quit')}
            ...
            <h1 className='flex text-3xl sm:text-4xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-700 via-gray-500 to-gray-700 my-6 sm:my-8 lg:my-12 animate-gradient'>{t('interview.title')}</h1>
