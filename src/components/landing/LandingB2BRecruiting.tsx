...
import { Building2, Users, BarChart3, Clock, CheckCircle, ClipboardList, Target, TrendingUp, Globe, type LucideIcon } from 'lucide-react'
...
export const LandingB2BRecruiting: React.FC<LandingB2BRecruitingProps> = ({ onWaitlistClick }) => {
  ...
  return (
    <section id="b2b-section" className="py-24 bg-zinc-50 relative overflow-hidden">
              ...
              {B2B_RECRUITER_FEATURES.map((feature, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex gap-4 p-4 bg-white rounded-xl border border-zinc-200 hover:border-purple-200 hover:shadow-md transition-all"
                  >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="mt-6 text-center">
                <Button
                  ...
                  disabled
                  className="border-zinc-300 text-zinc-500 px-8 py-6 text-base font-semibold cursor-not-allowed"
                >
