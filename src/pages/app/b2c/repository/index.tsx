        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 text-zinc-600 hover:text-zinc-900 hover:bg-white rounded-lg border border-zinc-200 transition-colors disabled:opacity-50"
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-zinc-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-zinc-500">{t('interviews.repository.stats.total')}</p>
          ...
          <div className="bg-white rounded-xl border border-zinc-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-zinc-500">{t('interviews.repository.stats.avgScore')}</p>
          ...
          <div className="bg-white rounded-xl border border-zinc-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-zinc-500">{t('interviews.repository.stats.totalTime')}</p>
                <p className="text-2xl font-bold text-zinc-900">{stats.totalTime} min</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-4 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <select
                ...
                className="px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
              ...
              {activeFilterCount > 0 && (
                <button
                  ...
                  className="px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900 transition-colors"
                >
          ...
          <AnimatePresence>
            {showFilters && (
              ...
              >
                <div className="pt-4 mt-4 border-t border-zinc-100 grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {/* Role Filter */}
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-zinc-50 border border-zinc-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                    >
              ...
              {filteredInterviews.map((interview, index) => (
                ...
                >
                  ...
                  <div className="lg:col-span-2 flex items-center gap-2 text-sm text-zinc-600">
                    <GraduationCap className="w-4 h-4 text-zinc-400 lg:hidden" />
                    <span className="px-2 py-0.5 bg-zinc-100 rounded text-xs font-medium">
                      {interview.seniority || 'N/A'}
                    </span>
                    {interview.language && (
                      <span className="hidden lg:inline-flex items-center gap-1 px-2 py-0.5 bg-zinc-100 rounded text-xs">
                  ...
                  {/* Duration */}
                  <div className="lg:col-span-1 flex items-center gap-2 text-sm text-zinc-600">
                    <Clock className="w-4 h-4 text-zinc-400 lg:hidden" />
                    <span>{formatDuration(interview.callDuration)}</span>
                  </div>
                  ...
                  <div className="lg:col-span-2 flex items-center gap-2">
                    ...
                    {interview.hasFeedback && (
                      <span className="hidden lg:inline-flex items-center gap-1 text-xs text-purple-600">
